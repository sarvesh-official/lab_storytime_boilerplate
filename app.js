...
function sweetTooth(totalNoOfSweets,sweetsConsumedByKaren,sweetsConsumedInNMeters,meterTsoTravel) {
    total = (totalNoOfSweets - sweetsConsumedByKaren) - (sweetsConsumedInNMeters * meterTsoTravel)
    return total/2
}
